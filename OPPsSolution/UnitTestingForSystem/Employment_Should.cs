...
namespace UnitTestingForSystem
{
    public class Employment_Should
    {
        ...
        public void Create_New_Greedy_Instance()
        {
            ...
            //manually alter the Years value to give correct data
            double expectedYears = 4.9;

            //When - Act execution
            //pass the expected values as argument values to your greedy constructor
            //notice that the string has leading and trailing spaces, this will check that
            //  you have .Trim() your title
            Employment actual = new Employment("  SAS Lead   ", SupervisoryLevel.TeamLeader,
                                                    new DateTime(2020, 10, 24), 4.9);
